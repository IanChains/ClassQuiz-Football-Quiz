...
<svelte:head>
	<title>Search - Football Is Life Quiz</title>
</svelte:head>

<div>
	<div class="flex justify-center">
		<div class="mb-3 mt-12 xl:w-96">
			<form
			...
			>
				<input
					...
					placeholder="Voer minimaal 3 tekens in ..."
					aria-label="Search"
...
{#if resp_data}
	...
	{:else}
		<div class="flex justify-center">
			<h1 class="text-4xl">Er is hier niks ...</h1>
		</div>
		<div class="flex justify-center">
			<p>Kan je niet vinden wat je zoekt?
			<br>Geen nood! <a class="underline" href="https://footballislife.be/contact" target="_blank">Contacteer ons</a> en laat een quiz maken op maat!
			</p>
		</div>
	{/if}
{/if}
