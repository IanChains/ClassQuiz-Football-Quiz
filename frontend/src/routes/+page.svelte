...
<svelte:head>
	...
	<meta name="description" content="Dit is de quiz site van Football Is Life!"/>
	<title>Quiz Football Is Life</title>
	<meta
		name="description"
		content="Dit is de quiz site van Football Is Life!"
	/>

	<meta property="og:url" content="https://quiz.footballislife.be/" />
	<meta property="og:type" content="website" />
	<meta property="og:title" content="Quiz Football Is Life" />
	<meta
		property="og:description"
		content="Dit is de quiz site van Football Is Life!"
	/>
	<meta property="og:image" content=$lib/logo.png />
	<meta name="apple-mobile-web-app-title" content="Quiz Football Is Life" />
	...
	{#if maintenance}
		<section class="pb-40">
			<div class="pt-12 text-center">
				<h1 class="sm:text-8xl font-bold text-6xl mt-6">Onderhoud - Quiz Site!</h1>
				<p class="text-3xl mt-4">Onze quiz site is momenteel tijdelijk in onderhoud en buiten gebruik.<br>We doen er alles aan om dit zo snel mogelijk af te ronden!<br>Hou de status op de hoogte via: <a href="https://status.ian-chains.it/" target="_blank" class="underline" style="overflow-wrap: break-word;">status.ian-chains.it</a><br><br>Heb je een vraag of een probleem?<br>IT Afdeling -> <a href="mailto:webmaster@footballislife.be" target="_blank" class="underline" style="overflow-wrap: break-word;">webmaster@footballislife.be</a></p>
			</div>
		</section>
	{:else}
		<section class="pb-40">
